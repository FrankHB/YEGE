...
void
IMAGE::putimage(PIMAGE pDstImg, int dstX, int dstY, int dstWidth, int dstHeight,
...
static
void
fix_rect_1size(PIMAGE pdest, PIMAGE psrc,
...
static
void
draw_flat_trangle_alpha_s(PIMAGE dc_dest, const triangle2d * dt, PIMAGE dc_src,
