...
EGEAPI void
putimage(int dstX, int dstY, IMAGE* pSrcImg, unsigned long dwRop = SRCCOPY); // 绘制图像到屏幕
EGEAPI void
putimage(int dstX, int dstY, int dstWidth, int dstHeight, IMAGE* pSrcImg, int srcX, int srcY, unsigned long dwRop = SRCCOPY);    // 绘制图像到屏幕(指定宽高)
EGEAPI void
putimage(int dstX, int dstY, int dstWidth, int dstHeight, IMAGE* pSrcImg, int srcX, int srcY, int srcWidth, int srcHeight, unsigned long dwRop = SRCCOPY);   // 绘制图像到屏幕(指定源宽高和目标宽高进行拉伸)
EGEAPI void
putimage(IMAGE* pDstImg, int dstX, int dstY, IMAGE* pSrcImg, unsigned long dwRop = SRCCOPY); // 绘制图像到另一图像中
EGEAPI void
putimage(IMAGE* pDstImg, int dstX, int dstY, int dstWidth, int dstHeight, IMAGE* pSrcImg, int srcX, int srcY, unsigned long dwRop = SRCCOPY);    // 绘制图像到另一图像中(指定宽高)
EGEAPI void
putimage(IMAGE* pDstImg, int dstX, int dstY, int dstWidth, int dstHeight, IMAGE* pSrcImg, int srcX, int srcY, int srcWidth, int srcHeight, unsigned long dwRop = SRCCOPY);   // 绘制图像到另一图像中(指定源宽高和目标宽高进行拉伸)
