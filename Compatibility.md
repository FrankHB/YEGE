...
* 颜色转换函数添加 `ynothrow` 。
* 修复函数 `RGBTOBGR` 的参数类型（[自 19.01](https://github.com/FrankHB/YEGE/commit/65d40255a6e3a006e3f425098bb24e38dcea746b#diff-7d3083d1613646a60d757feb7a58b101) ）。
...
* 修复函数 `getch` 阻塞不返回（[自 19.01](https://github.com/FrankHB/YEGE/commit/86d5bfd29538da85bb09b242c9a807608b5d11aa#diff-7a45f9d952914e7def2c69dde935ecfa)）。
